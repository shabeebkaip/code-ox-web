...
const Shimmer = () => {
    return (
        <div className='bg-white p-6 border border-gray-200 shadow-sm'>
            <div className="flex flex-col md:flex-row gap-6  animate-pulse min-h-[80vh]   container mx-auto">
                <div className="w-full md:w-1/2 flex justify-center items-center">
                    <div className="w-[90%] h-[60%] bg-gray-200 rounded-xl" />
                </div>

                <div className="w-full md:w-1/2 space-y-5 py-4 px-2  flex justify-center items-center flex-col">
